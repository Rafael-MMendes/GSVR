          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: '#475569', textTransform: 'uppercase', marginBottom: '4px' }}>Cargo/Função do Remetente</label>
                  <input
                    type="text"
                    className="form-control"
                    style={{ margin: 0, width: '100%' }}
                    value={memoSenderTitle}
                    onChange={(e) => setMemoSenderTitle(e.target.value)}
                  />
                </div>
              ...
              >
                ...
                <div className="bloco-militar-memo" style={{ pageBreakInside: 'avoid' }}>
                  ...
                  <div style={{ textAlign: 'center', marginTop: '40px', fontSize: '11pt', color: '#0f172a' }}>
                    ...
                    <p>
                      <span contentEditable suppressContentEditableWarning style={{ borderBottom: '1px dashed #94a3b8', padding: '0 2px', outline: 'none' }} onBlur={(e) => setMemoSenderTitle(e.target.innerText)}>{memoSenderTitle}</span>
                    </p>
                  </div>
                </div>
              </div>
